...
function ReviewPopup({ review, onClose, isOpen, isMobile }) {
      ...
      <div ref={popupContentRef} className={styles.reviewPopupContent}>
        ...
        <div className={styles.reviewPopupHeader}>
          ...
          <div className={styles.reviewPopupInfo}>
            <h2 className={`${styles.reviewPopupTitle} ${typography.heading2}`}>
              {review.title}
            </h2>
            ...
            <p className={`${styles.reviewPopupRating} ${typography.bodyText}`}>
              Rating: {review.rating.toFixed(1)}/10
            </p>
            <p className={`${styles.reviewPopupDate} ${typography.bodyText}`}>
